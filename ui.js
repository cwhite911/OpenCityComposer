...
export function predictClass(classId) {
  console.log("predictClass", CONTROL_CODES[classId]);
  // google.pacman.keyPressed(CONTROL_CODES[classId]);
      const DELTA_DISTANCE = 100;

      // degrees the map rotates when the left or right arrow is clicked
      const DELTA_DEGREES = 25;

      function easing(t) {
          return t * (2 - t);
      }

      switch (CONTROL_CODES[classId]) {
        case 38:
          map.panBy([0, -DELTA_DISTANCE], {
              easing: easing
          });
          break;
        case 40:
        ...
        case 37:
          map.easeTo({
              bearing: map.getBearing() - DELTA_DEGREES,
              easing: easing
          });
          break;
        case 39:
